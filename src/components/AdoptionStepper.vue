              ...
              <v-stepper-content step="4" editable>
                <v-card class="pa-8" elevation="0" color="#f7f7f7">
                  <v-row align="end">
                    <v-col cols="12" md="6">
                      <v-label
                        >How long will the dog be left alone each day?</v-label
                      >
                      <v-text-field
                    ...
                    <v-col cols="12">
                      <v-label
                        ...
                        current or newly adopted animal(s)?</v-label
                      >
                      <v-text-field
                    ...
                    <v-col cols="12" md="7">
                      <v-label
                        >Where will the dog stay when left alone? (House, Room,
                        Crate, Outside, etc)</v-label
                      >
                      <v-text-field
                    ...
                    <v-col cols="12">
                      <v-label
                        >How much time do you have prepared for your new dog to
                        adjust?</v-label
                      >
                      <v-text-field
                    ...
                    <v-col cols="12">
                      <v-label
                        >If you have a pickup truck, will the dog be left alone
                        or allowed to ride freely in the bed of the truck? If
                        yes, please explain.</v-label
                      >
                      <v-text-field
                    ...
                    <v-col cols="12">
                      <v-label
                        >What Problems or issues would make you return your dog
                        to the rescue?</v-label
                      >
                      <v-text-field
                  ...
                  <v-card-actions>
                    <v-btn color="success" @click="e6 = 1">
                      Submit
                    </v-btn>
                  </v-card-actions>
                </v-card>
